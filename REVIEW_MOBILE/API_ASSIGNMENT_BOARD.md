...
| `FAMILY_ContactList`                    | `SharedFamilyMockProvider` `getRelationships` API real                                                                 |     `✅ LIVE`      | Đã live GET /relationships cho Danh sách liên hệ (thay mock data)              | `@Minh6625`     |
| `FAMILY_AddMember`                      | `SharedFamilyMockProvider.sendRequest()`                                                                               |     `✅ LIVE`      | Đã live POST /relationships/request (gửi kèm Tags).                            | `@Minh6625`     |
| `FAMILY_LinkedContactDetail / Settings` | `LinkedContactDetailMockProvider`                                                                                      |     `✅ LIVE`      | Đã live API permissions/tags/unlink bằng PUT và DELETE /relationships/{id}.    | `@Minh6625`     |
