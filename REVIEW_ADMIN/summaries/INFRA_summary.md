...
| backend/src/app.js                      | Express app setup (CORS, routes) (1287B)     |
| backend/src/config/env.js               | Environment config (1094B)                   |
| backend/src/config/swagger.js           | Swagger spec (28587B)                        |
...
| backend/prisma/schema.prisma            | Prisma schema (22588B)                       |
| backend/prisma.config.ts                | Prisma config (392B)                         |
| backend/.env                            | DB_URL, JWT_SECRET, PORT, SMTP, FRONTEND_URL |
| backend/.env.example                    | Environment template (420B)                  |
