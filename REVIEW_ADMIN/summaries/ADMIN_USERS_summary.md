...
| Path                                                 | Role                                    |
| ---------------------------------------------------- | --------------------------------------- |
| backend/src/controllers/user.controller.js           | All user route handlers (2839B)         |
| backend/src/services/user.service.js                 | User CRUD + lock logic (9426B)          |
| backend/src/routes/user.routes.js                    | Route definitions + validation (3874B)  |
| backend/src/__tests__/controllers/user.controller.test.js | Controller tests (5847B)           |
| backend/src/__tests__/services/user.service.test.js  | Service tests (14442B)                  |
| frontend/src/pages/admin/UserManagementPage.jsx      | User management UI page (12418B)        |
