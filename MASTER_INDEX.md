...
| 2   | **HOME** — Main Navigation Shell, Bottom Nav with 5 Tabs                  | S1-S2  | N/A (UI Infra)     | [HOME_summary.md](REVIEW_MOBILE/summaries/HOME_summary.md)                 | 🔵 Scaffolding | —      | —       | —                                             | —           |
| 3   | **DEVICE** — Connect, List, Unbind, Status                                | S2     | UC040-UC042        | [DEVICE_summary.md](REVIEW_MOBILE/summaries/DEVICE_summary.md)             | ⬜ Not built   | —      | —       | —                                             | —           |
| 4   | **INFRA** — FastAPI Setup, Data Ingestion (MQTT/HTTP)                     | S1-S2  | N/A                | [INFRA_summary.md](REVIEW_MOBILE/summaries/INFRA_summary.md)               | ⬜ Partial     | —      | —       | —                                             | —           |
| 5   | **MONITORING** — View Vitals, Detail, History                             | S2     | UC006-UC008        | [MONITORING_summary.md](REVIEW_MOBILE/summaries/MONITORING_summary.md)     | ⬜ Not built   | —      | —       | —                                             | —           |
| 6   | **EMERGENCY** — Fall Detection, SOS (Manual/Auto), Response               | S3     | UC010-UC015        | [EMERGENCY_summary.md](REVIEW_MOBILE/summaries/EMERGENCY_summary.md)       | ⬜ Not built   | —      | —       | —                                             | —           |
| 7   | **NOTIFICATION** — Emergency Contacts, Alerts, Settings                   | S3     | UC030-UC031        | [NOTIFICATION_summary.md](REVIEW_MOBILE/summaries/NOTIFICATION_summary.md) | ⬜ Not built   | —      | —       | —                                             | —           |
| 8   | **ANALYSIS** — Risk Score, XAI Explainer                                  | S4     | UC016-UC017        | [ANALYSIS_summary.md](REVIEW_MOBILE/summaries/ANALYSIS_summary.md)         | ⬜ Not built   | —      | —       | —                                             | —           |
| 9   | **SLEEP** — Sleep Analysis, Sleep Report                                  | S4     | UC020-UC021        | [SLEEP_summary.md](REVIEW_MOBILE/summaries/SLEEP_summary.md)               | ⬜ Not built   | —      | —       | —                                             | —           |
| 10  | **PROFILE** — User Profile, Edit Profile, Logout                          | S1-S2  | UC009              | [PROFILE_summary.md](REVIEW_MOBILE/summaries/PROFILE_summary.md)           | ⬜ Placeholder | —      | —       | —                                             | —           |
