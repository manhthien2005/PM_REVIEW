...
| --- | ------------------------------------------------------------------------- | ------ | ------------------ | ------------------------------------------------------------------------- | ------------- | ------ | ------- | ------------------------------------------------------------- | ----------- |
| 1   | **AUTH** — Login, Register, Forgot/Reset/Change Password, Profile, Logout | S1     | UC001-UC005, UC009 | [AUTH_summary.md](REVIEW_ADMIN/summaries/AUTH_summary.md)                 | ✅ Done       | 91/100 | ✅ Pass | [View](REVIEW_ADMIN/AUTH_review.md)                           | 2026-03-08  |
...
| 3   | **DEVICES** — Create, List, Detail, Update, Assign, Unassign, Lock        | S4     | UC025              | [DEVICES_summary.md](REVIEW_ADMIN/summaries/DEVICES_summary.md)           | ⬜ Pending    | —      | —       | —                                                             | —           |
| 4   | **CONFIG** — System Settings (Thresholds, AI config)                      | S4     | UC024              | [CONFIG_summary.md](REVIEW_ADMIN/summaries/CONFIG_summary.md)             | ✅ Done       | 78/100 | ✅ Pass | [View](REVIEW_ADMIN/CONFIGURE_SYSTEM_CONFIG_review.md)        | 2026-03-11  |
...
| 2   | **HOME** — Main Navigation Shell, Bottom Nav with 5 Tabs                  | S1-S2  | N/A                | [HOME_summary.md](REVIEW_MOBILE/summaries/HOME_summary.md)                 | ✅ Built      | —      | —       | —                                             | —           |
| 3   | **DEVICE** — Connect, List, Unbind, Status                                | S2     | UC040-UC042        | [DEVICE_summary.md](REVIEW_MOBILE/summaries/DEVICE_summary.md)             | ✅ Built      | —      | —       | —                                             | —           |
| 4   | **FAMILY** — Caregiver/Patient User Relationships                         | S3     | N/A                | [FAMILY_summary.md](REVIEW_MOBILE/summaries/FAMILY_summary.md)             | ✅ Built      | —      | —       | —                                             | —           |
| 5   | **INFRA** — FastAPI Setup, Data Ingestion (MQTT/HTTP)                     | S1-S2  | N/A                | [INFRA_summary.md](REVIEW_MOBILE/summaries/INFRA_summary.md)               | ✅ Built      | —      | —       | —                                             | —           |
| 6   | **MONITORING** — View Vitals, Detail, History                             | S2     | UC006-UC008        | [MONITORING_summary.md](REVIEW_MOBILE/summaries/MONITORING_summary.md)     | ✅ Built      | —      | —       | —                                             | —           |
| 7   | **EMERGENCY** — Fall Detection, SOS (Manual/Auto), Response               | S3     | UC010-UC015        | [EMERGENCY_summary.md](REVIEW_MOBILE/summaries/EMERGENCY_summary.md)       | ✅ Built      | —      | —       | —                                             | —           |
| 8   | **NOTIFICATION** — Emergency Contacts, Alerts, Settings                   | S3     | UC030-UC031        | [NOTIFICATION_summary.md](REVIEW_MOBILE/summaries/NOTIFICATION_summary.md) | ⬜ Not built  | —      | —       | —                                             | —           |
| 9   | **ANALYSIS** — Risk Score, XAI Explainer                                  | S4     | UC016-UC017        | [ANALYSIS_summary.md](REVIEW_MOBILE/summaries/ANALYSIS_summary.md)         | ⬜ Not built  | —      | —       | —                                             | —           |
| 10  | **SLEEP** — Sleep Analysis, Sleep Report                                  | S4     | UC020-UC021        | [SLEEP_summary.md](REVIEW_MOBILE/summaries/SLEEP_summary.md)               | ✅ Built      | —      | —       | —                                             | —           |
| 11  | **PROFILE** — User Profile, Edit Profile, Logout                          | S1-S2  | UC009              | [PROFILE_summary.md](REVIEW_MOBILE/summaries/PROFILE_summary.md)           | ✅ Built      | —      | —       | —                                             | —           |
...
| 2026-03-08 | v2.4    | CHECK ADMIN: corrected API prefix /api/v1/, PATCH not PUT for users, +logout endpoint, +userService.js, expanded **tests** (10 files), removed seed-test-data.js, +API_GUIDE.md, updated 12 file sizes, 3 summaries updated |
