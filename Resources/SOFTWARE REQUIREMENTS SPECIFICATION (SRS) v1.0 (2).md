...
* **Tính năng Theo dõi Giấc ngủ**  
  * HG-FUNC-12: Hệ thống phân tích luồng dữ liệu sinh tồn và mô hình chuyển động để đánh giá chất lượng giấc ngủ, chấm điểm (Sleep Score) và phân loại các giai đoạn (Awake, Light, Deep, REM).
