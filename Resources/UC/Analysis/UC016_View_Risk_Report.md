...
- **BR-016-01**: Chỉ đánh giá lại sau 1 giờ (tránh spam)
- **BR-016-02**: Cần ít nhất 24 giờ dữ liệu liên tục
- **BR-016-03**: Nếu rủi ro HIGH/CRITICAL → Gửi thông báo đến người giám sát
- **BR-016-04**: Luôn hiển thị disclaimer: "Đây là công cụ hỗ trợ, không thay thế chẩn đoán y khoa"
