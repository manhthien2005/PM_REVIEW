...
- **BR-014-01**: Cần giữ nút SOS 3 giây để tránh bấm nhầm
- **BR-014-02**: Cho phép hủy SOS trong vòng 5 phút nếu là false alarm
- **BR-014-03**: Retry notification tối đa 3 lần
- **BR-014-04**: Emergency Contacts được gửi theo thứ tự ưu tiên (Priority 1-5)
