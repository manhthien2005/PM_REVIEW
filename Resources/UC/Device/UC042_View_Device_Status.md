...
| 2    | Hệ thống        | Truy vấn danh sách thiết bị của người dùng hiện tại.                                                                                       |
...
| Bước  | Người thực hiện | Hành động                                                                            |
| ----- | --------------- | ------------------------------------------------------------------------------------ |
| 5.a.1 | Hệ thống        | Nếu thời gian dừng kết nối vượt ngưỡng cấu hình (đã offline quá lâu, VD: > 30 phút). |
