...
| **Hậu điều kiện** | Danh sách Emergency Contacts được cập nhật trong bảng `emergency_contacts` và/hoặc `user_relationships`. |
...
| 4 | Hệ thống | Hiển thị form: Họ tên, Số điện thoại, Quan hệ (vợ/chồng, con, bác sĩ...), Ưu tiên, Kênh nhận (SMS/Call/Push nếu là user trong hệ thống). |
...
| 7 | Hệ thống | Lưu bản ghi vào `emergency_contacts` và/hoặc thiết lập quan hệ trong `user_relationships`. |
...
- **BR-030-01**: Một user có thể có nhiều `emergency_contacts`, nhưng priority phải là số nguyên dương; giá trị nhỏ hơn nghĩa là ưu tiên cao hơn. 
